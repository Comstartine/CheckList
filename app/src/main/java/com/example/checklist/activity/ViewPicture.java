...
import com.example.checklist.Customize.CancelOrOkDialog;
import com.example.checklist.Customize.ImageConstant;
import com.example.checklist.R;
import com.example.checklist.adapter.ViewPagerAdapter;

import java.util.ArrayList;

public class ViewPicture extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgList = getIntent().getStringArrayListExtra(ImageConstant.IMG_LIST);
        mPosition = getIntent().getIntExtra(ImageConstant.POSITION, 0);
        initView();
    }

    private void initView() {
        viewPager = findViewById(R.id.add_viewPager);
        positionTv = findViewById(R.id.add_position);
        findViewById(R.id.add_back).setOnClickListener(this);
        findViewById(R.id.add_delete).setOnClickListener(this);
    ...
    private void back() {
        ...
        intent.putStringArrayListExtra(ImageConstant.IMG_LIST, imgList);
        setResult(ImageConstant.RESULT_CODE_VIEW_IMG, intent);
        finish();
    }
